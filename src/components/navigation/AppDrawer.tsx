    ...
    <>
      ...
      >
        <div className="flex h-full flex-col">
          ...
          <div className="border-b border-border bg-gradient-to-r from-accent/10 to-accent/5 px-6 py-5 flex-shrink-0">
            <div className="flex items-center justify-between w-full">
              <div className="flex items-center gap-3 flex-1 min-w-0">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-accent shadow-lg flex-shrink-0">
